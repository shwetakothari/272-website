    ...
    <div class="ui text container" >
      ...
      <h2>
      	<form action="Verified.php" method="post">
      		Username: <input name="Username" type="text" style="color: #000" placeholder="Username"> </br>  </br>
      		Password: <input name="Password" type="password" style="color: #000" placeholder="Password"> </br> </br>
      		<input type="submit" value="Submit" name="submit" class="ui inverted  massive button" > 
      	</form>
