    ...
    <div class="ui text container" >
      ...
      <h2 class="ui inverted header">
          ...
          <?php
      		...
      		$passwords = fopen("password.txt","r") or die("Unable to open file!");
                 $line1 = fgets($passwords,255);
                 $line1 = chop($line1);
                 $field = split(",",$line1,2);
                 

      		if($Username == $field[0] && $Password == $field[1])
      		{
      	        echo ("<h1> Welcome to the secured page!! </h1>");
