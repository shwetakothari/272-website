...
<body>
  ...
  <div class="pusher">
    ...
    <div style="background-color: #E91E63;" class="ui inverted vertical masthead center aligned segment indexbackground">
      ...
      $query = "SELECT * FROM Users WHERE ". $select ."= '" . $category ."';";
          ...
          <div class="ui basic segment">
           <div class="ui stackable column grid">
            ...
            <div class="fourteen wide column">
              ...
              <h2 class = "ui  header"></h2><h2 class = "ui  header"> <?php echo $result->num_rows; ?> Result!</h2><table class="ui  table">
              <thead>
                <tr>
