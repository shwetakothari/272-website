    ...
    <div class="ui container">
      <div class="ui large secondary inverted pointing menu">
        <a class="toc item">
          ...
          <a class=" active item" href="Users.php">Users</a>
    ...
    <div class="ui text container" >
      <h1 class="ui inverted header">
       <div class="ui doubling stackable grid container">
		...
		<div><a class="ui fluid inverted button" href = "Create.php">Create</a></div><br/>
		<div><a class="ui fluid inverted button" href = "Query.php">Query</a></div><br/>
		<div><a class="ui fluid inverted button" button" href = "AllUserInfo.php">All User Info From My website</a></div><br/>
		<div><a class="ui fluid inverted button" href = "AllUserInfoFromAllCompany.php">All User Info From Market Place</a></div><br/>
               </div>
            </div>
         </div>
    </div>
