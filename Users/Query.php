        ...
        <div class="ui doubling stackable grid container">
            <div class="sixteen wide column">
               <div class="ui vertical masthead segment">
                     ...
                     <div class="ui segment" style="background-color: #E91E63;">
                        <div class="ui stackable column grid">
                           <div class="three wide column"></div>
                           <div class="nine wide column">
                              <form class = "ui  form" method="post" action="Fetch_data.php">
                                 <p> 
                                 <h1> select a field to display:</h2>

                                 <select class="ui fluid dropdown" name = "select">
                                    <option class="item" selected="selected">FirstName</option>
                                    <option class="item">LastName</option>
                                    <option class="item" >Email</option>
                                    <option class="item">CellPhone</option>
                                 </select>

                                 </br>
                                 </br>
                                 <div >    
                                    <input type = "text" name = "category" placeholder = "Please enter something">
                                    </br>
                                     </br>
                                    </br> 
                                    <input class="ui inverted button  " type="submit" name = "Fetch" value = "Send Query" > 
