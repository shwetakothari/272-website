      ...
      <div style="background-color: #E91E63;" class="ui inverted vertical masthead center aligned segment indexbackground">
       ...
       <div class="ui two column centered grid">
        <div class="four column centered row">
          ...
          <div class="column"><img src="../images/1.jpeg" alt="Darphin Oil"  height="100%" width="100%"></div>
          <div class="column">
            <h3 class = "ui yellow header">Golden dress</h1>
