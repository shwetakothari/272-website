    ...
    <div style="background-color: #E91E63;" class="ui inverted vertical masthead center aligned segment indexbackground">
     ...
     <div class="ui two column centered grid">
      <div class="four column centered row">
        ...
        <div class="column"><img src="../images/2.jpeg" alt="Darphin Oil"  height="100%" width="100%"></div>
        <div class="column">
          <h3 class = "ui yellow header">Orange beach wear</h1>
            <p style="color: yellow; font-size:110%">
             Description:<br/>
   <?php
               ...
               if(! isset( $_COOKIE["product"] ) )
               ...
               else
                {
                  ...
                  if ($counter == 4) 
                   ...
                   {
                    $counter = $counter +1;
                    $array[$counter] = 2;// the product number clicked 
                   }
                  setcookie("counter",$counter);
...
<h3 class= "ui yellow header">$135
  <?php 

  $a = unserialize($_COOKIE["product"]);
...
<<link rel="stylesheet" href="../style.css"><div class="ui large purple  animated button" tabindex="0">
                     <div class="visible content">
                        <i class="star  yellow icon"></i>
                     </div>
                    
                  </div>
                  <div class="ui large yellow  animated button" tabindex="0">
                     <div class="visible content">
                        <i class="shop pink icon"></i>
                     </div>
</div>
</div>
