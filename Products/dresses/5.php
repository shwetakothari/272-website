...
<!-- ui vertical masthead center aligned segment indexbackground -->
  <div style="background-color: #E95E63;" class="ui inverted vertical masthead center aligned segment indexbackground">
    ...
    <br>
       ...
       <div class="ui two column centered grid">
            ...
            <br><br>
               ...
               <div class="column"><img src="../images/5.jpeg" alt="Darphin Oil"  height="500%" width="500%"></div>
               <div class="column">
                  <h3 class = "ui yellow header">Yello Emma Stone dress</h5>
               ...
               if(! isset( $_COOKIE["product"] ) )
               ...
               else
                {
                  ...
                  if ($counter == 4) 
                   ...
                   {
                    $counter = $counter +1;
                    $array[$counter] = 5;// the product number clicked 
                   }
                  setcookie("counter",$counter);
  ...
  print_r($array);
                ...
                else
                {
                  ...
                  $array = unserialize($_COOKIE["mcounter"]);
                  print_r($array);
                  $array['prod5'] = $array['prod5'] + 1;
                  $mcounter = serialize($array );
                  setcookie("mcounter",$mcounter);

                }
          ?>
                  <h3 class= "ui yellow header">$535</h3>
                  </p>
  ...
  <div style="background-color: #E95E63" class="ui inverted vertical footer segment">
    <div class="ui container">
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.5.3/jquery.min.js'></script>
