...
<!-- ui vertical masthead center aligned segment indexbackground -->
    ...
    <br>
       ...
       <div class="ui two column centered grid">
            ...
            <br><br>
               ...
               <div class="column"><img src="../images/3.jpeg" alt="Darphin Oil"  height="100%" width="100%"></div>
               <div class="column">
                  <h3 class = "ui yellow header">Black party dress</h1>
               ...
               if(! isset( $_COOKIE["product"] ) )
               ...
               else
                {
                  ...
                  if ($counter == 4) 
                   ...
                   {
                    $counter = $counter +1;
                    $array[$counter] = 3;// the product number clicked 
                   }
                  setcookie("counter",$counter);
  ...
  print_r($array);
          ...
          ?>
                  ...
                  <div class="ui large purple  animated button" tabindex="0">
