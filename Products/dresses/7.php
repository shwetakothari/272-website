    ...
    <br>
       ...
       <div class="ui two column centered grid">
            ...
            <br><br>
               ...
               <div class="column"><img src="../images/7.jpeg" alt="Darphin Oil"  height="100%" width="100%"></div>
               <div class="column">
                  <h3 class = "ui yellow header">American Eagle dress</h1>
               ...
               if(! isset( $_COOKIE["product"] ) )
               ...
               else
                {
                  ...
                  if ($counter == 4) 
                   ...
                   {
                    $counter = $counter +1;
                    $array[$counter] = 7;// the product number clicked 
                   }
                  setcookie("counter",$counter);
